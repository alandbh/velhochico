        ...
        <div className="py-22 text-center">
          ...
          <div className="text-2xl mt-12 gap-y-6 flex flex-col">
            <p>
              ...
              Pousada Velho Chico, você poderá se deliciar com os sabores
              típicos da nossa terra.
            </p>
            <p>
            ...
            <p>
              Além disso, você poderá aproveitar frutas colhidas diretamente do
              pé como laranja, abacate, manga, caju, jambo, goiaba, pitanga,
              jaca, ameixa e amora.
            </p>
          </div>
        </div>
